...
M: Payoffs = {
  ...
  (Strategy.AlwaysCooperate, Strategy.X): 2*B/3-C,
  ...
  (Strategy.TitForTat, Strategy.X): B-C,
  ...
  (Strategy.AlwaysDefect, Strategy.X): B,
  (Strategy.X, Strategy.AlwaysCooperate): B-2*C/3,
  (Strategy.X, Strategy.TitForTat): B-C,
  (Strategy.X, Strategy.AlwaysDefect): -C,
  (Strategy.X, Strategy.X): (3/4)*(B-C),
}
